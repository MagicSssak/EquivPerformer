...
def get_flags():
    ...
    parser.add_argument('--lag_step', type=int, default=2, help="Grad Accumulation")
    # Data
    ...
    parser.add_argument('--data_name', type=str, default='Scanobjectnn')




    # Logging
    parser.add_argument('--name', type=str, default='4090', help="Run name")
